...
{
    public class CloakMain : Network
    {
        ...
        public const string StratisRootFolderName = "cloak";

        /// <summary> The default name used for the Stratis configuration file. </summary>
        public const string StratisDefaultConfigFilename = "cloak.conf";
        ...
        public CloakMain()
        {
            ...
            Block genesisBlock = CreateCloakGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
        ...
        protected static Block CreateCloakGenesisBlock(ConsensusFactory consensusFactory, uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
        {
